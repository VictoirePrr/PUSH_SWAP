...
/*   Updated: 2025/02/04 13:50:03 by vicperri         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
If my temp is bigger than data->max,
data->max will now be equal to temp.
I also take advantage of this iteration
to retrive the position of the biggest node.*/
